...
const SidebarSheet = () => {
  return (
    <SheetContent className="overflow-y-auto">
      ...
      <div className="flex-items-center flex gap-3 border-b border-solid py-5">
        <Avatar>
        ...
        <div>
          <p className="font-bold">Gabriel Strieder</p>
          <p className="font-text-xs">gabriel@gabriel.com</p>
        </div>
      </div>
